...
class funcdeclare:
    ...
    def CostofItem(self):
        ...
        DishesPrice = "Ksh", str('%.2f' % (PriceofDishes))
        CostofDishes.set(DishesPrice)
        CostofDrinks.set(DrinksPrice)
        SC = "Ksh", str('%.2f' % (2.5))
        ServiceCharge.set(SC)

        SubTotalofITEMS = "Ksh", str('%.2f' % (PriceofDrinks + PriceofDishes + 2.5))
        SubTotal.set(SubTotalofITEMS)

        Tax = "Ksh", str('%.2f' % ((PriceofDrinks + PriceofDishes + 2.5) * 0.5))
        PaidTax.set(Tax)
        TT = ((PriceofDrinks + PriceofDishes + 2.5) * 0.5)
        TC = "Ksh", str('%.2f' % (PriceofDishes + PriceofDrinks + 2.5 + TT))
        TotalCost.set(TC)
    ...
    def Receipt(self):
        ...
        txtReceipt.insert(END, 'Chapo Ndengu: \t\t\t\t' + E_Cndengu.get() + "\n")
        txtReceipt.insert(END, 'Fries: \t\t\t\t' + E_Fries.get() + "\n")
        txtReceipt.insert(END, 'Ugali nyama: \t\t\t\t' + E_Unyama.get() + "\n")
        txtReceipt.insert(END, 'Tea and Bread: \t\t\t\t' + E_Tbread.get() + "\n")
        txtReceipt.insert(END, 'Rice Ndengu: \t\t\t\t' + E_Rndengu.get() + "\n")
        txtReceipt.insert(END, 'Smocha: \t\t\t\t' + E_Smocha.get() + "\n")
